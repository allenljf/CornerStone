...
public class SideBar extends View {
    ...
    public SideBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        letterColor = context.getResources().getColor(R.color.blue_3574fa);
        selectColor = context.getResources().getColor(R.color.black_222328);
        letterSize = dip(context, 11f);
